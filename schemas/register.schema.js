...
export const Register = z.object({
  ...
  userlastname: z.string({ message: "Type error, must be string" }).min(3, { message: "Must be 3 or more characters long" }).max(30, { message: "Must be 30 or less characters long" }),
